...
const MenuKelas = () => {
  return (
    <div className="mb-20 hidden md:flex  md:px-12 lg:px-8">
        ...
        <div className="flex w-full ">
          <div className="w-full mt-8">
            <div className="w-full grid grid-cols-2 md:grid-cols-2 gap-4 md:gap-8 xl:grid-cols-4 mx-auto  " >
              ...
              {
                KategoriKelasData && KategoriKelasData.map((item,index) => (
                  <div key={index}>
                    <div
                      data-aos="fade-right"
                    ...
                    >
                      ...
                      >
                        {item.title}
                        <p className="text-base lg:text-[12px] xl:text-base text-slate-500 font-semibold">{item.subtitle}</p>
                      </h5>
                    </div>
                  </div>
                ))
